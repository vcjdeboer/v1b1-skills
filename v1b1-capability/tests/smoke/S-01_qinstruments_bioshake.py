# Smoke fixture S-01: QInstruments BioShake
# Source: pylabrobot v1b1 commit d3c6d0a5, pylabrobot/qinstruments/bioshake.py
# Vendored: 2026-04-25 (verbatim copy; no edits)
...
#   P-13 multi-capability shared driver (BioShakeShakerBackend + BioShakeTemperatureBackend)
#   P-04 chatterbox-extends-Driver discovery exception (BioShakeChatterboxDriver)
#   P-22 nested SetupParams in driver
#   P-27 Driver.setup signature convention
#   P-23 Resource integration via multiple inheritance (BioShake(PlateHolder, Device))
